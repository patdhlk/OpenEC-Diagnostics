...
│   └── design/                 # Per-milestone design docs (spec + refinements + decisions)
└── README.md
```
...
- **[docs/design/](docs/design/README.md)** — the design record: a
  consolidated design document per milestone, capturing the specification,
  the refinements made while building it, and the decisions behind them. They
