...
docs/                     TAP setup guide, design specs, implementation plans
```

`docs/superpowers/` holds the design specs and implementation plans each
milestone was built from. They were written as working documents for
AI-assisted development, so they read a little unusually, but they are the
best record of *why* the architecture is shaped the way it is — worth reading
before a substantial change. See [docs/superpowers/README.md](docs/superpowers/README.md).
